...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Donald Knuth"); // call to HelloWorld(string name) again with a differnt parameter value HelloWorld("Alan Turing", DateTime.Now.Year - 1912); // call to HelloWorld(string name, int inputAge), which is an overloaded method
...
Console.WriteLine("\n");
        ...
        decimal sum = Add(inputNumber1, inputNumber2);
            ...
            // if you don't plan on using a variable, you can simplify the method calllike the lines below
        ...
        * there are other tags in 
        https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/xmldoc/recomm
        ended-tags
        */
